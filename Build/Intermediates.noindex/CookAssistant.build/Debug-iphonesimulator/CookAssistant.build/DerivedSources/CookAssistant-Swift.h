...
#ifndef COOKASSISTANT_SWIFT_H
#define COOKASSISTANT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CookAssistant",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13CookAssistant23AddRecipeViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tfIngrediente;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tfTiempo;
@property (nonatomic, weak) IBOutlet UIStepper * _Null_unspecified stCantidad;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tfCantidad;
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified favoriteStar;
...
SWIFT_CLASS("_TtC13CookAssistant11AppDelegate")
...
SWIFT_CLASS("_TtC13CookAssistant11Ingrediente")
...
SWIFT_CLASS("_TtC13CookAssistant6Receta")
...
SWIFT_CLASS("_TtC13CookAssistant13SceneDelegate")
...
SWIFT_CLASS("_TtC13CookAssistant33TableViewControllerRecetasPrevias")
@interface TableViewControllerRecetasPrevias : UITableViewController
- (void)viewDidLoad;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13CookAssistant14ViewController")
...
SWIFT_CLASS("_TtC13CookAssistant19customTableViewCell")
@interface customTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imgFotoReceta;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbNombreReceta;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbTime;
...
SWIFT_CLASS("_TtC13CookAssistant20customTableViewCell2")
